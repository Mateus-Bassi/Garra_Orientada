//Documento Feito por Mateus Bassi
...
void setup()
{
  ...
  attachInterrupt(digitalPinToInterrupt(btn_garra),movi_garra,RISING);
...
int reset_garra(){ // inicia o movimento de retorno da garra (sem "soco")
